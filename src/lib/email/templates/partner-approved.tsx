  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#555", lineHeight: 1.6 }}>
        ...
        <strong>{pointName}</strong> foi aprovado e já está visível no mapa do
        EcoMed para todos os usuários.
      </p>
      ...
      >
        <p style={{ color: "#15803d", margin: 0, fontSize: 14 }}>
          🗺️ Os usuários próximos já podem encontrar seu ponto de coleta no mapa
          interativo. Obrigado por contribuir com o descarte correto de
