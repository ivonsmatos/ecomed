  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#555", lineHeight: 1.6 }}>
        Olá, <strong>{partnerName}</strong>. Um usuário reportou um problema no
        ponto <strong>{pointName}</strong>.
      </p>
      ...
      <p style={{ color: "#555", lineHeight: 1.6 }}>
        Verifique as informações do seu ponto e, se necessário, atualize os
        dados ou entre em contato com nossa equipe.
      </p>
