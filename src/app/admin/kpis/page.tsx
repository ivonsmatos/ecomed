...
function LevelDistribution({ levels, total }: { levels: typeof DATA.levels; total: number }) {
  const items = [
...
function TaskDonut({ tasks }: { tasks: typeof DATA.tasks }) {
      ...
      <div style={{ padding: "20px 24px" }}>
        ...
        <div style={{ marginTop: 32, paddingTop: 16, borderTop: `1px solid ${colors.border}`, textAlign: "center" }}>
          <p style={{ fontSize: 11, color: "#999" }}>
            EcoMed — Painel de KPIs v1.0 | Dados simulados — conectar ao banco para dados reais | ecomed.eco.br
          </p>
        </div>
      </div>
    </div>
