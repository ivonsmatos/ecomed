        ...
        <section className="bg-[#0d3b1a] py-24 text-center">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <h1 className="font-sans text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-6">
              Descarte certo,{" "}
              <span className="text-eco-lime">planeta saudável</span>
            </h1>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <ul className="space-y-4 text-gray-600">
                  <li className="flex gap-3">
                    <span className="text-eco-lime font-bold text-lg">✓</span>
              ...
              <div className="bg-eco-teal/10 rounded-2xl p-8 text-center">
        ...
        <section className="py-20 bg-[#0d3b1a] text-white">
          <div className="container mx-auto px-4 max-w-3xl text-center">
            ...
            <p className="text-white/80 leading-relaxed mb-8">
              O EcoMed atua alinhado à <strong className="text-eco-lime">Lei 12.305/2010</strong> (Política Nacional de Resíduos Sólidos) e ao <strong className="text-eco-lime">Decreto 10.388/2020</strong>, que regulamenta a logística reversa de medicamentos domiciliares no Brasil — obrigando fabricantes, distribuidores e importadores a manter pontos de coleta acessíveis à população.
            </p>
            <a
              href="/mapa"
              className="inline-block bg-eco-green text-white font-semibold px-8 py-4 rounded-full hover:bg-eco-green/90 transition-colors"
            >
