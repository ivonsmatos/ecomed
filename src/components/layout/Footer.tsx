...
import { Phone, Mail, ChevronRight, Facebook, Instagram, Twitter, Linkedin } from "lucide-react";

/* Fiel ao Echofy Footer.jsx — dark bg com footer-bg.jpg, social box, shapes */
export function Footer() {
  return (
    <footer className="bg-[url('/echofy/footer-bg.jpg')] bg-no-repeat bg-center bg-cover relative z-10 pt-28 overflow-hidden">
            ...
            <div className="flex flex-col gap-7 lg:gap-0 lg:flex-row lg:items-center lg:justify-between p-10">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <ul className="flex gap-3">
                  {[
                    { icon: <Facebook className="size-4" />, href: "https://facebook.com", label: "Facebook" },
                    { icon: <Instagram className="size-4" />, href: "https://instagram.com", label: "Instagram" },
                    { icon: <Twitter className="size-4" />, href: "https://twitter.com", label: "Twitter" },
                    { icon: <Linkedin className="size-4" />, href: "https://linkedin.com", label: "LinkedIn" },
                  ].map(({ icon, href, label }) => (
                    <li key={label}>
                      <a
                        href={href}
